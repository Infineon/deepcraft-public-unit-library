...
#pragma IMAGINET_FRAGMENT_BEGIN "dps_feature_extraction_f32"

/*
 * Extract 19 statistical and derivative features from a DPS pressure +
 ...
 */
static void dps_feature_extraction_f32(
