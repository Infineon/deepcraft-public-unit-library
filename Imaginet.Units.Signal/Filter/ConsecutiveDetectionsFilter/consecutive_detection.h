...
static inline void
consecutive_detection(const float *restrict input, float *restrict output,
                      float confidence_threshold, int8_t *detect_count,
                      int8_t min_consecutive_count, int8_t *last_detected_class,
                      int default_class_index, int num_classes) {
