...
static inline void consecutive_confidence_filter_f32(const float* restrict input, float* restrict output, int8_t* gesture_count, int8_t* prev_detected_gesture, float* gesture_confidence_detected, int count, float threshold, float min_detection_threshold, int count_threshold, int reset_count, int null_count, int use_confidence_tracking)
{
