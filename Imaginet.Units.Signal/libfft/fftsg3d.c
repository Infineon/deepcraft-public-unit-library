...
static void cdft3d(int n1, int n2, int n3, int isgn, double ***a, 
...
static void rdft3d(int n1, int n2, int n3, int isgn, double ***a, 
    double *t, int *ip, double *w)
{
    void makewt(int nw, int *ip, double *w);
...
static void rdft3dsort(int n1, int n2, int n3, int isgn, double ***a)
{
    int n1h, n2h, i, j;
    double x, y;
...
static void ddct3d(int n1, int n2, int n3, int isgn, double ***a, 
    double *t, int *ip, double *w)
{
    void makewt(int nw, int *ip, double *w);
    void makect(int nc, int *ip, double *c);
...
static void ddst3d(int n1, int n2, int n3, int isgn, double ***a, 
    double *t, int *ip, double *w)
{
    void makewt(int nw, int *ip, double *w);
    void makect(int nc, int *ip, double *c);
...
static void xdft3da_sub(int n1, int n2, int n3, int icr, int isgn, 
    double ***a, double *t, int *ip, double *w)
{
...
static void cdft3db_sub(int n1, int n2, int n3, int isgn, double ***a, 
    double *t, int *ip, double *w)
{
    void cdft(int n, int isgn, double *a, int *ip, double *w);
    int i, j, k;
...
static void ddxt3da_sub(int n1, int n2, int n3, int ics, int isgn, 
    double ***a, double *t, int *ip, double *w)
{
...
static void ddxt3db_sub(int n1, int n2, int n3, int ics, int isgn, 
    double ***a, double *t, int *ip, double *w)
{
    void ddct(int n, int isgn, double *a, int *ip, double *w);
    void ddst(int n, int isgn, double *a, int *ip, double *w);
...
static void xdft3da_subth(int n1, int n2, int n3, int icr, int isgn, 
    double ***a, double *t, int *ip, double *w)
{
...
static void cdft3db_subth(int n1, int n2, int n3, int isgn, double ***a, 
    double *t, int *ip, double *w)
{
...
static void ddxt3da_subth(int n1, int n2, int n3, int ics, int isgn, 
    double ***a, double *t, int *ip, double *w)
{
...
static void ddxt3db_subth(int n1, int n2, int n3, int ics, int isgn, 
    double ***a, double *t, int *ip, double *w)
{
