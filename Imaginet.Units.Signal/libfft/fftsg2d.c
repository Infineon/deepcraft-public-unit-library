...
static void cdft2d(int n1, int n2, int isgn, double **a, double *t, 
    int *ip, double *w)
{
...
static void rdft2d(int n1, int n2, int isgn, double **a, double *t, 
    int *ip, double *w)
{
    void makewt(int nw, int *ip, double *w);
...
static void rdft2dsort(int n1, int n2, int isgn, double **a)
{
    int n1h, i;
    double x, y;
...
static void ddct2d(int n1, int n2, int isgn, double **a, double *t, 
    int *ip, double *w)
{
    void makewt(int nw, int *ip, double *w);
    void makect(int nc, int *ip, double *c);
